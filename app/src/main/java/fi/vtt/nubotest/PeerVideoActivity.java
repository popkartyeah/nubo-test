...
public class PeerVideoActivity extends Activity implements NBMWebRTCPeer.Observer, RoomListener {
    ...
    protected void onStart() {
        ...
        NBMMediaConfiguration peerConnectionParameters = new NBMMediaConfiguration(
                ...
                new NBMMediaConfiguration.NBMVideoFormat(1280, 720, PixelFormat.RGB_888, 25),
                NBMMediaConfiguration.NBMCameraPosition.BACK);

        videoRequestUserMapping = new HashMap<>();

        nbmWebRTCPeer = new NBMWebRTCPeer(peerConnectionParameters, this, rootEglBase.getEglBaseContext(), localView, this);
